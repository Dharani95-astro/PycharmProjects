...
print(sys.path)
# setting path
# sys.path.append('/media/dharani/62e5bcf5-360d-4eaa-96fd-12679ba22eaf/home/dharani/PycharmProjects/VIBE/lib')
# sys.path.append('/media/dharani/62e5bcf5-360d-4eaa-96fd-12679ba22eaf/home/dharani/PycharmProjects/VIBE/lib/models')
sys.path.append("/media/dharani/62e5bcf5-360d-4eaa-96fd-12679ba22eaf/home/dharani/PycharmProjects/VIBE")

from kp_utils import get_perm_idxs
...
def read_data(folder):
    ...
    for fname in tqdm(file_names):
        ...
        features = extract_features(model, np.array(imgs) , bbox, dataset='penn_action', debug=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, help='dataset directory', default='/media/dharani/62e5bcf5-360d-4eaa-96fd-12679ba22eaf/home/dharani/PycharmProjects/VIBE/data/vibe_db/penn_action')
    args = parser.parse_args()
    print(args.dir)
    # args.dir = "data/vibe_db/penn_action"
    args.dir = "/media/dharani/62e5bcf5-360d-4eaa-96fd-12679ba22eaf/home/dharani/PycharmProjects/VIBE/data/vibe_db/penn_action"
    dataset = read_data(args.dir)
    joblib.dump(dataset, osp.join(VIBE_DB_DIR, 'penn_action_train_db.pt'))
