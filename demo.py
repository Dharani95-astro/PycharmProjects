...
def main(args):
    ...
    # video_file = 'https://www.youtube.com/watch?v=wPZP8Bwxplo'
    print(torch.cuda.is_available())

    video_file = '/media/dharani/62e5bcf5-360d-4eaa-96fd-12679ba22eaf/home/dharani/Downloads/data/training/image_02/0019/out.mp4'
    # video_file = '/home/dharani/Downloads/Experimental result of CityScape datasets (detection).mp4'
    ...
    output_folder = "/home/dharani/Videos"
    # output_path = os.path.join(output_folder, os.path.basename(video_file).replace('.3gpp', ''))
    output_path = os.path.join(output_folder, os.path.basename(video_file).replace('', ''))
